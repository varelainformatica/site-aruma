...
if (mobileMenuButton && mobileMenuPanel) {
  mobileMenuButton.addEventListener('click', function () {
    var menuEstaFechado = mobileMenuPanel.hasAttribute('hidden');
...
function goToPortfolio() {
  ...
  setTimeout(function () {
    const secaoFinal = document.querySelector('#page-atuacao .atu-close');

    if (secaoFinal) {
      const destino = secaoFinal.offsetTop - 120;
